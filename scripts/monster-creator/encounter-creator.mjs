...
export class MonsterCreatorApp {
  ...
  static async open() {
    const mod = await import("../encounter/encounter-roller-app.mjs");
  ...
  async _prepareContext() {
    ...
    let loaderData = null;
    if (this._loaderOpen) {
      const { EncounterBrowse } = await import("../encounter/encounter-browse.mjs");
  ...
  async _onBulkImport() {
    const mod = await import("../importer/monsters/monster-importer-app.mjs");
