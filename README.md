...
|  **[Pit Fighting](docs/wiki/Pit-Fighting.md)** | Cursed Scroll 2 bouts, set up in the book's order: venue, stakes off the fighters' average level, and a danger level the book leaves to you. The twist is rolled up front and stays hidden — including when it's nothing — until you reveal it. Prize and fame at the end; the descriptions come from your own imported tables. Eleven bundled battle maps open as scenes, offered by the venue you rolled — plus a two-level tavern cellar you can walk between floors of. |
...
nothing else. Nothing is encrypted. There is no text to ship.
...
system already ships is skipped, because you already have it.
