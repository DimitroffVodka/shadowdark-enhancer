...
776 tracked files · ~108,900 lines of code/markup across scripts+templates+styles+test.
...
| `pdf-text-extract.mjs` | 661 | Clean reading-ordered PDF text via Foundry's bundled PDF.js; column-aware gutter detection. |
