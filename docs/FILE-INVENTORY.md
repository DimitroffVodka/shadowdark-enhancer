...
730 tracked files · ~99,400 lines of code/markup across scripts+templates+styles+test.
...
| `spell-mishap/spell-mishap.mjs` | 248 | Nat-1 spellcasting failures auto-roll the class's mishap table (wizard / witch / necromancer sets); divine casters are exempt. |
