...
821 tracked files · ~122,800 lines of code/markup across scripts+templates+styles+test.
...
| `char-content/class-unit-importer.mjs` | 1361 | Class unit → real documents in dependency order. |
