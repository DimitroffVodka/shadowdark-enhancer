...
949 tracked files · ~158,700 lines of code/markup across scripts+templates+styles+test.
...
| `hex-map/hex-tagger-app.mjs` | 1065 | Hex Tagger AppV2: contact sheet over the active hex scene, anchor numbering, tags on the scene flag, dataset hand-off. |
...
| `hex-map/tag-store.mjs` | 260 | The tagger's scene-flag store: compact tag strings, sheet selection (random/keyed/review), dataset tags. Pure. |
