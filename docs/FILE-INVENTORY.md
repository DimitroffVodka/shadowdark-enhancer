...
910 tracked files · ~147,700 lines of code/markup across scripts+templates+styles+test.
...
| `art-gallery.mjs` | 541 | GM-curated portrait gallery (avoids granting players `FILES_BROWSE`). |
