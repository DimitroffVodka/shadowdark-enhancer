...
[`actors`](#actors--western-reaches-boats) · [`quests`](#quests--the-quest-log)
...
Added in 1.6.0. One place for "what are we doing", whether it came from a
...
- `1.6.0` adds the `quests` namespace (the Quest Log) and the
