...
Turn enforcement on if you want over-budget moves *refused* instead of merely
...
module ships none and they are book content. Open the **Loot Generator → Set up
loot tables** and bind a table per treasure tier. If you have imported the system's
...
ability-generation method now, since it is **GM-dictated** and shown read-only to
